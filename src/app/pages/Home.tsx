        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="order-2 lg:order-1">
            ...
            >
              Больше,<br />
              чем скалодром<br />
              <span className="text-muted-foreground">школа настоящего альпинизма</span>
            </h2>
            <div className="space-y-5 text-sm leading-relaxed text-muted-foreground max-w-xl">
              <p>
                Мы - это не просто зал с искусственным рельефом. 
                Это полноценная школа, где новички становятся уверенными скалолазами, а бывалые туристы оттачивают технику перед серьезными вершинами.
              </p>
              <p>
                Наши тренировки проходят на специализированной стене, 
                конструкция которой позволяет моделировать любые типы рельефа - от вертикальных плит до сложных нависаний и щелей. 
              </p>
              <p>
                Но стены недостаточно, чтобы почувствовать горы. 
                Поэтому «живая» часть нашей жизни - это регулярные выезды в походы. 
                Мы выходим в скалы, отрабатываем связки на реальном рельефе и учимся принимать решения в условиях, максимально приближенных к автономным восхождениям. 
                Вместе мы проходим маршруты, которые в одиночку покорить было бы страшно или скучно.
              </p>
            </div>
